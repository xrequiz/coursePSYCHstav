...
ה-Blob מוגש עם `max-age=31536000` (קאש שנה בדפדפן וב-Office viewer). **דריסת קובץ באותו נתיב לא תגיע למשתמשים** — מעלים בשם חדש (למשל `03-v2.pptx`) ומעדכנים את הנתיב ב-`PREP`/`MATERIALS`. כך עודכנו 6 ההכנות של מפגשים 1–2 לגרסאות המוערות (04/07/2026).
